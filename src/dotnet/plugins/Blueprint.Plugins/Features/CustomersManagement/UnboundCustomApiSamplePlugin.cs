...
{
    public class UnboundCustomApiSamplePlugin : PluginBase
    {
        //if custom api is bounded to an entity type, empty string should be provided to ctor base class.
        public UnboundCustomApiSamplePlugin() : base(string.Empty)
        {
            ...
            this.AddStep(string.Empty, Stage.CoreOperation, Message.sample_customapiname, ExecutionMode.Sync, ExecuteCustomApi);
        }
